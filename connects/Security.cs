    ...
    class Security
    {
        ...
        private static void geral()
        {
            ...
            foreach (string line in lines)
            {
                ...
                if (lineposicao == 0) { settings.m_HName = DecryptText(words[1].ToString(), true); }
                if (lineposicao == 1) { settings.m_DBName = DecryptText(words[1].ToString(), true); }
                if (lineposicao == 2) { settings.m_UName = DecryptText(words[1].ToString(), true); }
                if (lineposicao == 3) { settings.m_Pass = DecryptText(words[1].ToString(), true); }
                //if (lineposicao == 4) { Properties.Settings.Default["m_Prefix"] = DecryptText(words[1].ToString(), true); }
                //if (lineposicao == 5) { Properties.Settings.Default["m_Url"] = DecryptText(words[1].ToString(), true); }
                //if (lineposicao == 6) { Properties.Settings.Default["m_Token"] = DecryptText(words[1].ToString(), true); }
